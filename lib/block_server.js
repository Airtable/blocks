...
class BlockServer {
    ...
    _fireRequestToBackend(req, res) {
        ...
        this._apiClient.fetchAccessPolicyAsync().then(accessPolicyBody => {
            ...
            // Also read global config so its available in the backend code.
            this._apiClient.readBlockInstallationGlobalConfigAsync(apiAccessPolicyString).then(globalConfigBody => {
                const globalConfig = globalConfigBody.globalConfig;
