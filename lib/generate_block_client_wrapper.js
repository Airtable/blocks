...
module.exports = function generateBlockClientWrapperCode(frontendEntryModulePath, url) {
    ...
    return `
        ...
        window['${blocksConfigSettings.GLOBAL_RUN_BLOCK_FUNCTION_NAME}'] = function runBlock() {
            ...
            var pollUrl = process.env.BLOCK_LONG_POLL_URL;
            ...
            function pollForLiveReload() {
                ...
                fetch(pollUrl + '?random=' + Math.random()).then(function(response) {
