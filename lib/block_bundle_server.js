...
class BlockBundleServer {
    ...
    _setUpBackendProcess() {
        ...
        // to the backend proess while it is starting up.
        ...
        this._backendProcess.on('message', response => {
            if (response.messageType === BlockBackendMessageTypes.RESPONSE) {
            ...
            } else if (response.messageType === BlockBackendMessageTypes.PROCESS_STARTED) {
