 ...
 * @option {Boolean} [options] `ignoreBlocks` Preserves all blocks regardless of their content
 * @return {String} modified input
 * @api public
 */

const strip = (module.exports = (input, options) => {
    const opts = {block: true, line: true, ...options};
