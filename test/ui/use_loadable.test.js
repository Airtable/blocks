...
describe('useLoadable', () => {
    ...
    it('renders immediately if already loaded and keeps loaded throughout', async () => {
        ...
        // make sure loading is complete by incrementing and decrementing the retain count
        ...
        // unload our initial thing.loadDataAsync(), the component should stay loaded
        thing.unloadData();
        jest.runAllTimers();
