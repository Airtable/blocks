...
function getRouteAndParamsForEvent(event, routes) {
  var matchedRouteIdAndParams = null;
  for (var _i = 0, _Object$keys = Object.keys(routes); _i < _Object$keys.length; _i++) {var routeId = _Object$keys[_i];
...
callUserCodeForEventAsync(_x, _x2, _x3) {return _callUserCodeForEventAsync.apply(this, arguments);}function _callUserCodeForEventAsync() {_callUserCodeForEventAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event, routes, developerCredentialByName) {var routeAndParams, route, params, sdkWrapperInstance, blockDirPath, routeHandlerModule, errorMessage, handler, requestObj, responsePromise, response;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
            ...
            event.method.toUpperCase() === 'OPTIONS')) {_context.next = 2;break;}return _context.abrupt("return",
            {
              statusCode: 200,
              headers: [
              ...
              'access-control-allow-headers', '*'] });case 2:




            routeAndParams = getRouteAndParamsForEvent(event, routes);if (!(
            routeAndParams === null)) {_context.next = 5;break;}return _context.abrupt("return", _objectSpread({


              statusCode: 404 },
            generateResponseBodyBase64('NOT_FOUND')));case 5:


            route = routeAndParams.route, params = routeAndParams.params;_context.prev = 6;


            sdkWrapperInstance = global[blocksConfigSettings.GLOBAL_SDK_VARIABLE_NAME];if (
            sdkWrapperInstance) {_context.next = 10;break;}throw (
              new Error('SDK not set on global'));case 10:_context.next = 12;return (


              sdkWrapperInstance.__initializeSdkForEventAsync(event, developerCredentialByName));case 12:

            blockDirPath = getBlockDirPath();
            routeHandlerModule = require(path.join(blockDirPath, blocksConfigSettings.BUILD_DIR, 'backendRoute', route.metadata.name));if (!(
            !routeHandlerModule || _typeof(routeHandlerModule) !== 'object' || typeof routeHandlerModule["default"] !== 'function')) {_context.next = 18;break;}
            ...
            responsePromise = Promise.resolve(handler(requestObj));_context.next = 23;return (

              responsePromise);case 23:response = _context.sent;return _context.abrupt("return",
            response);case 27:_context.prev = 27;_context.t0 = _context["catch"](6);
            ...
            generateResponseBodyBase64({
              ...
              message: 'SERVER_ERROR' })));case 31:case "end":return _context.stop();}}}, _callee, null, [[6, 27]]);}));return _callUserCodeForEventAsync.apply(this, arguments);}function
...
symlinkBackendAndSharedFoldersAsync() {return _symlinkBackendAndSharedFoldersAsync.apply(this, arguments);}function _symlinkBackendAndSharedFoldersAsync() {_symlinkBackendAndSharedFoldersAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {var blockDirPath, buildDirPath, folderNames, _i2, _folderNames, folderName, folderPath, nodeModulesPath;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
            blockDirPath = getBlockDirPath();
            buildDirPath = path.join(blockDirPath, blocksConfigSettings.BUILD_DIR);
            folderNames = ['backendRoute', 'shared'];
            for (_i2 = 0, _folderNames = folderNames; _i2 < _folderNames.length; _i2++) {folderName = _folderNames[_i2];
              folderPath = path.join(buildDirPath, folderName);
              nodeModulesPath = path.join(blockDirPath, 'node_modules', folderName);
              fsUtils.symlinkIfNeededAsync(folderPath, nodeModulesPath);
            }case 4:case "end":return _context3.stop();}}}, _callee3);}));return _symlinkBackendAndSharedFoldersAsync.apply(this, arguments);}function
...
transpileBackendAndSharedCodeAsync() {return _transpileBackendAndSharedCodeAsync.apply(this, arguments);}function _transpileBackendAndSharedCodeAsync() {_transpileBackendAndSharedCodeAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {var blockDirPath, sharedFiles, backendRouteFiles, filesByModuleType, buildDirPath, backendBuildDirPath, sharedBuildDirPath, transpilationPromises, jsRegex, _i3, _Object$keys2, moduleType, files, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, file, transpilationPromise;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
            ...
            buildDirPath = path.join(blockDirPath, blocksConfigSettings.BUILD_DIR);_context5.next = 11;return (
            ...
            jsRegex = /\.js$/;_i3 = 0, _Object$keys2 =
            Object.keys(filesByModuleType);case 20:if (!(_i3 < _Object$keys2.length)) {_context5.next = 45;break;}moduleType = _Object$keys2[_i3];
            files = filesByModuleType[moduleType] || [];_iteratorNormalCompletion2 = true;_didIteratorError2 = false;_iteratorError2 = undefined;_context5.prev = 26;
            ...
            }_context5.next = 34;break;case 30:_context5.prev = 30;_context5.t0 = _context5["catch"](26);_didIteratorError2 = true;_iteratorError2 = _context5.t0;case 34:_context5.prev = 34;_context5.prev = 35;if (!_iteratorNormalCompletion2 && _iterator2["return"] != null) {_iterator2["return"]();}case 37:_context5.prev = 37;if (!_didIteratorError2) {_context5.next = 40;break;}throw _iteratorError2;case 40:return _context5.finish(37);case 41:return _context5.finish(34);case 42:_i3++;_context5.next = 20;break;case 45:_context5.next = 47;return (

              Promise.all(transpilationPromises));case 47:case "end":return _context5.stop();}}}, _callee5, null, [[26, 30, 34, 42], [35,, 37, 41]]);}));return _transpileBackendAndSharedCodeAsync.apply(this, arguments);}function


checkIfBackendRoutesExistInBlockJson(_x9) {return _checkIfBackendRoutesExistInBlockJson.apply(this, arguments);}
...
function _checkIfBackendRoutesExistInBlockJson() {_checkIfBackendRoutesExistInBlockJson = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(modules) {var blockDirPath, blockJsonBackendRouteFiles, backendRouteFiles, jsRegex;return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:blockDirPath = getBlockDirPath();blockJsonBackendRouteFiles = new Set();modules.forEach(function (module) {if (module.metadata.type === 'backendRoute') {blockJsonBackendRouteFiles.add("".concat(module.metadata.name, ".js"));}});_context6.next = 5;return fsUtils.readDirAsync(path.join(blockDirPath, 'backendRoute'));case 5:backendRouteFiles = _context6.sent;jsRegex = /\.js$/;backendRouteFiles.forEach(function (file) {if (jsRegex.test(file) && !blockJsonBackendRouteFiles.has(file)) {var formattedFileName = getFormattedProjectPath('backendRoute', file, '');console.warn("".concat(formattedFileName, " is being ignored since this file could not be found in block.json."));console.warn("Please add an entry for ".concat(formattedFileName, " to block.json to resolve this error."));}});case 8:case "end":return _context6.stop();}}}, _callee6);}));return _checkIfBackendRoutesExistInBlockJson.apply(this, arguments);}function requireFromString(src) {
...
downloadBackendSdkAsync(_x10, _x11) {return _downloadBackendSdkAsync.apply(this, arguments);}
...
/**
                                                                                               ...
                                                                                               *    helps prevent it.
                                                                                               */function _downloadBackendSdkAsync() {_downloadBackendSdkAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(blockJson, blockDirPath) {var baseUrl, environment, sdkUrl, response, backendSdkJs, BackendBlockSdkWrapper;return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:environment = blockJson.environment || Environments.PRODUCTION;_context7.t0 = environment;_context7.next = _context7.t0 === Environments.PRODUCTION ? 4 : _context7.t0 === Environments.STAGING ? 6 : _context7.t0 === Environments.LOCAL ? 8 : _context7.t0 === Environments.TEST ? 10 : 12;break;case 4: // NOTE: this should probably download from the cdn, but we can't do that
            ...
            baseUrl = 'https://airtable.com/js/compiled';return _context7.abrupt("break", 13);case 6: // NOTE: see comment above.
            baseUrl = 'https://staging.airtable.com/js/compiled';return _context7.abrupt("break", 13);case 8:baseUrl = 'https://hyperbasedev.com:3000/js/build';return _context7.abrupt("break", 13);case 10:baseUrl = "http://localhost:".concat(blocksConfigSettings.TEST_SERVER_PORT, "/js/compiled");return _context7.abrupt("break", 13);case 12:throw new Error("Unrecognized environment: ".concat(environment));case 13:sdkUrl = "".concat(baseUrl, "/block_backend_sdk.js");_context7.next = 16;return request.getAsync({ uri: sdkUrl });case 16:response = _context7.sent;if (!(response.statusCode !== 200)) {_context7.next = 19;break;}throw new Error("Failed to download backend SDK with statusCode: ".concat(response.statusCode));case 19:backendSdkJs = response.body; // This is sketchy: some runtime checks for "am I running in Node" check that
            ...
            global.self = global;BackendBlockSdkWrapper = requireFromString(backendSdkJs);return _context7.abrupt("return", BackendBlockSdkWrapper);case 23:case "end":return _context7.stop();}}}, _callee7);}));return _downloadBackendSdkAsync.apply(this, arguments);}function getDeveloperCredentialByName() {var developerCredentialByName;if (process.env.DEVELOPER_CREDENTIAL_BY_NAME) {developerCredentialByName = JSON.parse(process.env.DEVELOPER_CREDENTIAL_BY_NAME);} else {developerCredentialByName = {};}delete process.env.DEVELOPER_CREDENTIAL_BY_NAME;
  return developerCredentialByName;
}function

setUpBackend() {return _setUpBackend.apply(this, arguments);}function _setUpBackend() {_setUpBackend = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {var blockDirPath, rawBlockJson, blockJson, modules, routes, developerCredentialByName, BackendBlockSdkWrapper, sdkWrapperInstance;return regeneratorRuntime.wrap(function _callee9$(_context9) {while (1) {switch (_context9.prev = _context9.next) {case 0:
            // Parse block.json.
            ...
            // warnings otherwise.
            _context9.next = 8;return checkIfBackendRoutesExistInBlockJson(modules);case 8:_context9.next = 10;return (
            ...
            process.on('message', /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(event) {var response;return regeneratorRuntime.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:
                        ...
                        response));case 5:case "end":return _context8.stop();}}}, _callee8);}));return function (_x12) {return _ref.apply(this, arguments);};}());
            ...
            process.send({
              ...
              pid: process.pid });case 22:case "end":return _context9.stop();}}}, _callee9);}));return _setUpBackend.apply(this, arguments);}
