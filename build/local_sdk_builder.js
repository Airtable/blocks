...
LocalSdkBuilder = /*#__PURE__*/function () {_createClass(LocalSdkBuilder, null, [{ key: "startIfNeededAsync", value: function () {var _startIfNeededAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(
  ...
  }_createClass(LocalSdkBuilder, [{ key: "startAsync", value: function () {var _startAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {var copySourcePath, copyDestPath;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:


                console.log("Installing local SDK from ".concat(this.sdkPath, "..."));_context3.next = 3;return (
                  this._installLocalSdkAsync());case 3:

                console.log("Building local SDK in ".concat(this.sdkPath, "..."));_context3.next = 6;return (
                  this._buildAndWatchSourceAsync());case 6:

                copySourcePath = path.join(this.sdkPath, 'dist');
                copyDestPath = path.join(getBlockDirPath(), 'node_modules', SDK_PACKAGE_NAME, 'dist');
                console.log("Copying local SDK build from ".concat(copySourcePath, " to ").concat(copyDestPath));_context3.next = 11;return (
                  this._copyAndWatchBuildAsync(copySourcePath, copyDestPath));case 11:case "end":return _context3.stop();}}}, _callee3, this);}));function startAsync() {return _startAsync.apply(this, arguments);}return startAsync;}() }, { key: "_installLocalSdkAsync", value: function () {var _installLocalSdkAsync2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {var blockDir, shouldUseYarn;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:



                blockDir = getBlockDirPath();_context4.next = 3;return (
                  fsUtils.existsAsync(path.join(blockDir, 'yarn.lock')));case 3:shouldUseYarn = _context4.sent;_context4.next = 6;return (
                  ...
                  shouldUseYarn ? ['add', this.sdkPath, '--non-interactive'] : ['install', this.sdkPath],
                  {
                    ...
                    cwd: getBlockDirPath() }));case 6:case "end":return _context4.stop();}}}, _callee4, this);}));function _installLocalSdkAsync() {return _installLocalSdkAsync2.apply(this, arguments);}return _installLocalSdkAsync;}() }, { key: "_buildAndWatchSourceAsync", value: function _buildAndWatchSourceAsync()
