...
Type: [Array][9]&lt;[Table][10]>

Returns **[Array][9]&lt;[Table][10]>**
...
function (records: [Array][9]&lt;[Record][11]>, field: [Field][12]): any, aggregateToString:
function (records: [Array][9]&lt;[Record][11]>, field: [Field][12]): [string][4]}
...
-   `aggregate` **function (records: [Array][9]&lt;[Record][11]>, field: [Field][12]): any**
-   `aggregateToString` **function (records: [Array][9]&lt;[Record][11]>, field: [Field][12]):
    [string][4]**
...
Type: {width: [number][13], height: [number][13]}

Returns **{width: [number][13], height: [number][13]}**
...
-   `recordOrRecordId` **([Record][11] \| [string][4])**
...
-   `record` **[Record][11]** the record to expand
...
-   `records` **[Array][9]&lt;[Record][11]>** the records to expand. Duplicate records will be
    removed.
-   `opts` **{fields: [Array][9]&lt;[Field][12]>?}?**
...
-   `records` **[Array][9]&lt;[Record][11]>** the records the user can pick from. Duplicate records
    will be removed.
-   `opts` **{fields: [Array][9]&lt;[Field][12]>?, shouldAllowCreatingRecord: [boolean][1]?}?**
...
Returns **[Promise][14]&lt;(record | null)>** a Promise that resolves to the record chosen by the
user or null
...
Returns **[HTMLStyleElement][15]** the style tag inserted into the page.
...
Returns **[Promise][14]&lt;[HTMLLinkElement][16]>** a Promise that resolves to the style tag
...
Returns **[Promise][14]&lt;[HTMLScriptElement][17]>** a Promise that resolves to the script tag
inserted into the page.
...
Type: [Array][9]&lt;[Field][12]>

Returns **[Array][9]&lt;[Field][12]>**
...
Returns **[TableOrViewQueryResult][21]**
...
Type: [Array][9]&lt;[Record][11]>

Returns **[Array][9]&lt;[Record][11]>**
...
Returns **AirtableWriteAction&lt;void, {record: [Record][11]}>**

### canCreateRecords

#### Parameters

-   `recordDefsOrNumberOfRecords` **([Array][9]&lt;RecordDef> | [number][13])**
...
Returns **AirtableWriteAction&lt;void, {records: [Array][9]&lt;[Record][11]>}>**
...
Type: {type: [string][4], options: ([Object][19] | null)}

Returns **{type: [string][4], options: ([Object][19] | null)}**
...
Type: [Array][9]&lt;[Aggregator][22]>

Returns **[Array][9]&lt;[Aggregator][22]>**

### isAggregatorAvailable

#### Parameters

-   `aggregator` **([Aggregator][22] \| [string][4])**
...
-   `fieldOrFieldIdOrFieldName` **([Field][12] \| [string][4])**
...
Returns **({r: [number][13], g: [number][13], b: [number][13]} | null)**
...
[15]: https://developer.mozilla.org/docs/Web/API/HTMLStyleElement
[16]: https://developer.mozilla.org/docs/Web/API/HTMLLinkElement
[17]: https://developer.mozilla.org/docs/Web/API/HTMLScriptElement
[18]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Statements/function
[19]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Object
[20]: #view
[21]: #tableorviewqueryresult
[22]: #aggregator
[23]: https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Date
