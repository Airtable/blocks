...
import createNewBaseGif from './setup_1.gif';
import buildABlockGif from './setup_2.gif';
import nameBlockPng from './setup_3.png';
import helloWorldBlockPng from './setup_4.png';
import helloWorldEditedPng from './setup_5.png';
...
**Next, we’ll learn to [how to make a to-do list block!](guides/todo)**
