...
Controls the block's settings button. See [SettingsButton][65].
...
dimensions added with [Viewport#addMaxFullscreenSize][75].

If `width` or `height` is null, it means there is no max size constraint on that dimension. If
`maxFullscreenSize` would be smaller than [Viewport#minSize][76], it is constrained to be at least
`minSize`.
...
-   Limited XSS protection. If the `href` starts with `javascript:` or `data:`, `http://` will be
    prepended.
-   There is [reverse tabnabbing prevention][144]. If `target` is set, the `rel` attribute will be
...
-   `props` **[RecordCardProps][149]**

#### RecordCardProps

Type: {record: ([Record][84] | RecordDef), fields: [Array][69]&lt;[Field][81]>?, view: [View][82]?,
attachmentCoverField: [Field][81]?, width: [number][74]?, height: [number][74]?, onClick:
[Function][72]?, getExpandRecordOptions: function ([Record][84]): [ExpandRecordOpts][150]?,
onMouseEnter: any?, onMouseLeave: any?, className: [string][68]?, style: [Object][73]?,
viewMetadata: ([ViewMetadataQueryResult][107] | null)}

##### Properties

-   `record` **([Record][84] | RecordDef)**
-   `fields` **[Array][69]&lt;[Field][81]>?**
-   `view` **[View][82]?**
-   `attachmentCoverField` **[Field][81]?**
-   `width` **[number][74]?**
-   `height` **[number][74]?**
-   `onClick` **[Function][72]?**
-   `getExpandRecordOptions` **function ([Record][84]): [ExpandRecordOpts][150]?**
-   `onMouseEnter` **any?**
-   `onMouseLeave` **any?**
-   `className` **[string][68]?**
-   `style` **[Object][73]?**
...
-   `value` **([string][68] \| [number][74] \| [boolean][70] | null)?** The value of the selected
    option.
-   `options` **[Array][69]&lt;[SelectOption][152]>** The list of select options.
...
[139]: #iconprops
[140]: https://github.com/Airtable/blocks/blob/master/packages/sdk/docs/icons.md
[141]: #fieldiconprops
[142]: #inputprops
[143]: #inputsyncedprops
[144]: https://www.owasp.org/index.php/Reverse_Tabnabbing
[145]: #linkprops
[146]: #loaderprops
[147]: #popoverprops
[148]: #progressbarprops
[149]: #recordcardprops
[150]: #expandrecordopts
[151]: #selectprops
[152]: #selectoption
