...
class QueryResult extends AbstractModelWithAsyncData<QueryResultData, WatchableQueryResultKey> {
    ...
    static __createOrReuseQueryResult(sourceModel: TableModel | ViewModel, opts: QueryResultOpts) {
        ...
        if (queryResult) {
            ...
            return new QueryResult(sourceModel, opts);
        }
    }
    static _normalizeOpts(table: TableModel, opts: QueryResultOpts): NormalizedQueryResultOpts {
    ...
    constructor(
        ...
        this._normalizedOpts = QueryResult._normalizeOpts(this._table, opts || {});
    ...
    get _dataOrNullIfDeleted(): QueryResultData | null {
    ...
    watch(keys: WatchableQueryResultKey | Array<WatchableQueryResultKey>, callback: Function, context?: any): Array<WatchableQueryResultKey> { // eslint-disable-line flowtype/no-weak-types
        ...
        for (const key of validKeys) {
            ...
            if (key === WatchableQueryResultKeys.cellValues) {
    ...
    async _loadDataAsync(): Promise<Array<WatchableQueryResultKey>> {
        ...
        const changedKeys = [
            WatchableQueryResultKeys.records,
            WatchableQueryResultKeys.recordIds,
            WatchableQueryResultKeys.cellValues,
        ];
    ...
    _onRecordsChanged(model: TableModel | ViewModel, key: string, updates: ?{addedRecordIds: Array<string>, removedRecordIds: Array<string>}) {
        ...
        this._onChange(WatchableQueryResultKeys.records, updates);
        this._onChange(WatchableQueryResultKeys.recordIds, updates);
    }
    _onCellValuesForSortChanged(table: TableModel, key: string, recordIds: ?Array<string>, fieldId: ?string) {
        ...
        this._onChange(WatchableQueryResultKeys.records, changeData);
        this._onChange(WatchableQueryResultKeys.recordIds, changeData);
    }
    ...
    _onCellValuesChanged(table: TableModel, key: string, updates: ?Object) {
        ...
        this._onChange(WatchableQueryResultKeys.cellValues, updates);
    }
