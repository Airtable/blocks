...
import {uploadSubmitAsync} from '../helpers/upload_submit';
...
`,
    ...
    async runAsync() {
        ...
        // pick an output build directory to write the bundle to
        ...
        // collect the unique paths in projectItems and dependencies
        ...
        // exclude directory paths that may have been included
        const filesOnly = (
            await Promise.all(
        ...
        // find the longest path that all filepaths start with
        ...
        // upload archive
        const submitResponseMessage = await uploadSubmitAsync(uploadOptions, {
            archiveBuffer,
        });
