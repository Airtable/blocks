...
export default class Init extends AirtableCommand {
    ...
    static description = 'Initialize a Airtable app project';
...
// rest of the fields like `name` and `version` to suit their needs. The set of
// fields here reflects what is specified in the hand-crafted hello-world
// template.
