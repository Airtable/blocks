...
describe('system_extra', () => {
    ...
    describe('watchFileAsync', () => {
        ...
        const triggerReadTimeUpdate = async (path: string) => {
            ...
            // Continuously modify the test subject's access time until the
            // process has recognized a change.
        ...
        // This test cannot pass with the simulated file system due to a bug in
        // the underlying library:
        //
        // > watchFile doesn't work on non-existent file
        // > https://github.com/streamich/memfs/issues/627
        wfaTest
            .prepareFixture('task_resolve_local')
            .it(
