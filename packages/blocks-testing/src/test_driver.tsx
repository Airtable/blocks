...
// explicit links redundant, Airtable's build process is currently unable to
// associate the types used by this source file with their corresponding
// definitions in the blocks-sdk package.
export default class TestDriver {
    ...
    setActiveCursorModels(tableAndOrView: TableAndOrView) {
        // The project's documentation is not capable of accurately
        // representing destructured parameters. In order to promote the
        // utility of the rendered documentation, perform the destructuring in
        // the function body rather than in the parameter list
