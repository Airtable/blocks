...
const cannotSimulateErrorMessage =
    ...
    '\n\n' +
    'Extensions which retrieve model references using JavaScript `import` ' +
    'declarations cannot be tested. To resolve this, replace `import` ' +
    "declaration in your Extension's source code with corresponding React " +
...
export default class VacantAirtableInterface extends AbstractMockAirtableInterface {
    ...
    setSettingsButtonVisibility() {
        // eslint-disable-next-line no-console
        console.warn(
            'The Settings button cannot be simulated in the Extension testing environment.',
        );
    }
    ...
    setUndoRedoMode() {
        // eslint-disable-next-line no-console
        console.warn(
            'The `undoRedo` feature cannot be simulated in the Extension testing environment.',
        );
    }
    ...
    trackEvent() {
        // eslint-disable-next-line no-console
        console.warn(
            'Event tracking signals cannot be observed in the Extension testing environment.',
        );
    }
    ...
    sendStat() {
        // eslint-disable-next-line no-console
        console.warn(
            'Statistic tracking signals cannot be observed in the Extension testing environment.',
        );
    }
}
