/*
Originally pasted from https://github.com/flow-typed/flow-typed/blob/master/definitions/npm/yargs_v10.x.x/flow_v0.54.x-/yargs_v10.x.x.js

CHANGELOG:
- added `hidden` to Options type, since it wasn't included but is supported by yargs.
- added PositionalOptions type and positional function.
*/
declare module "yargs" {
  ...
  declare type PositionalOptions = $Shape<{
    alias: string | Array<string>,
    choices: Array<mixed>,
    coerce: (arg: mixed) => mixed,
    conflicts: string | { [key: string]: string },
