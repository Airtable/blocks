...
async function main() {
    ...
    try {
        ...
        console.log('Running git mirror sync...');
        execCommand(`../../tools/git-mirror/bin/git-mirror sync @airtable/blocks@${versionString}`);
        console.log(`✅ Git mirror sync completed for @airtable/blocks@${versionString}`);
