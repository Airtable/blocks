...
const airtable = require('eslint-plugin-airtable');
const airtableBlocks = require('@airtable/eslint-plugin-blocks');
...
module.exports = defineConfig([
    {
        ignores: ['node_modules', 'dist', 'examples', '/*.js'],
        languageOptions: {
            globals: {
                ...globals.browser,
                ...globals.node,
        ...
        plugins: {
            airtable,
            '@airtable/blocks': airtableBlocks,
            react,
        ...
        rules: {
            ...
            '@airtable/blocks/no-error-interpolation': [
                'error',
                {
                    spawnError: 0,
                    invariant: 1,
