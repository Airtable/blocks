...
-   [@airtable/blocks/ui][23]
    ...
    -   [SelectSynced][52]
    -   [SelectButtons][53]
    -   [SelectButtonsSynced][54]
    -   [TablePicker][55]
    -   [TablePickerSynced][56]
    -   [Toggle][57]
    -   [ToggleSynced][58]
    -   [Tooltip][59]
    -   [ViewPicker][60]
    -   [ViewPickerSynced][61]
    -   [ViewportConstraint][62]
...
Accepts partial input, in the same format as [setAsync][65]. The more information provided, the more
accurate the permissions check will be.

###### Parameters

-   `key` **([string][66] \| [Array][67]&lt;[string][66]>)?** A string for the top-level key, or an
    array of strings describing the path to set.
-   `value` **([GlobalConfigValue][68] | void)?** The value to set at the specified path. Use
...
Accepts partial input, in the same format as [setPathsAsync][69]. The more information provided, the
more accurate the permissions check will be.

###### Parameters

-   `updates` **($ReadOnlyArray&lt;{path: ($ReadOnlyArray&lt;([string][66] | void)> | void)?, value:
    ([GlobalConfigValue][68] | void)?}> | void)?**
...
Returns **([GlobalConfigValue][68] | void)** The value at the provided path, or `undefined` if no
...
Returns **[boolean][70]** boolean Whether or not the user can set the specified key.
...
Returns **[boolean][70]** boolean Whether or not the user has permission to apply the specified
...
Returns **[Promise][71]&lt;void>** A promise that will resolve once the update is persisted to
Airtable.
...
-   `updates` **[Array][67]&lt;{path: [Array][67]&lt;[string][66]>, value:
    [GlobalConfigValue][68]}>** The paths and values to set.
...
-   `keys` **(WatchableGlobalConfigKey | [Array][67]&lt;WatchableGlobalConfigKey>)** the keys to
    unwatch
...
Returns **[Array][67]&lt;WatchableGlobalConfigKey>** the array of keys that were unwatched
...
Returns **[Array][67]&lt;WatchableGlobalConfigKey>** the array of keys that were watched

#### GlobalConfigKey

Type: ([string][66] \| [Array][67]&lt;[string][66]>)

#### GlobalConfigValue

Type: (null | [boolean][70] \| [number][74] \| [string][66] \|
[Array][67]&lt;[GlobalConfigValue][68]> | [Object][73]&lt;[string][66], [GlobalConfigValue][68]>)
...
The [useSettingsButton][75] hook is the recommend way to watch the settings button, but you can also
...
-   `keys` **(WatchableSettingsButtonKey | [Array][67]&lt;WatchableSettingsButtonKey>)** the keys to
    unwatch
-   `callback` **[Function][72]** the function passed to `.watch` for these keys
-   `context` **[Object][73]??** the context that was passed to `.watch` for this `callback`

Returns **[Array][67]&lt;WatchableSettingsButtonKey>** the array of keys that were unwatched
...
Returns **[Array][67]&lt;WatchableSettingsButtonKey>** the array of keys that were watched
...
dimensions added with [addMaxFullscreenSize][76].

If `width` or `height` is null, it means there is no max size constraint on that dimension. If
`maxFullscreenSize` would be smaller than [minSize][77], it is constrained to be at least `minSize`.
...
-   `keys` **(WatchableViewportKey | [Array][67]&lt;WatchableViewportKey>)** the keys to unwatch
-   `callback` **[Function][72]** the function passed to `.watch` for these keys
-   `context` **[Object][73]??** the context that was passed to `.watch` for this `callback`

Returns **[Array][67]&lt;WatchableViewportKey>** the array of keys that were unwatched
...
-   `keys` **(WatchableViewportKey | [Array][67]&lt;WatchableViewportKey>)** the keys to watch
-   `callback` **[Function][72]** a function to call when those keys change
-   `context` **[Object][73]??** an optional context for `this` in `callback`.

Returns **[Array][67]&lt;WatchableViewportKey>** the array of keys that were watched
...
An [ISO 8601][78] formatted date time.
...
See [fieldTypes.DATE][79] and [fieldTypes.DATE_TIME][80] for `result` options.
...
A valid URL (e.g. airtable.com or [https://airtable.com/universe][81]).
...
-   `selectField` **[Field][82]**

Returns **{type: recordColoring.ModeTypes.BY_SELECT_FIELD, selectField: [Field][82]}**
...
Returns **{type: recordColoring.ModeTypes.BY_VIEW, view: [View][83]}**
...
An enum of the different types of [recordColoring.modes][84]
...
Returns **[string][66]** The ID for this model.
...
Returns **[string][66]** A string representation of the model for use in debugging.
...
-   `keys` **(WatchableKey | [Array][67]&lt;WatchableKey>)**
-   `callback` **[Function][72]**
-   `context` **[Object][73]??**

Returns **[Array][67]&lt;WatchableKey>**
...
Type: {key: [string][66], displayName: [string][66], shortDisplayName: [string][66], aggregate:
function (records: [Array][67]&lt;[Record][85]>, field: [Field][82]): any, aggregateToString:
function (records: [Array][67]&lt;[Record][85]>, field: [Field][82]): [string][66]}

#### Properties

-   `key` **[string][66]**
-   `displayName` **[string][66]**
-   `shortDisplayName` **[string][66]**
-   `aggregate` **function (records: [Array][67]&lt;[Record][85]>, field: [Field][82]): any**
-   `aggregateToString` **function (records: [Array][67]&lt;[Record][85]>, field: [Field][82]):
    [string][66]**
...
Type: [Array][67]&lt;CollaboratorData>
...
Returns **[Array][67]&lt;CollaboratorData>** The users who have access to this base.
...
does not have access to this base. Use [getCollaboratorByIdIfExists][86] instead if you are unsure
...
-   `tableId` **[string][66]** The ID of the table.

Returns **[Table][87]** The table matching the given ID. Throws if that table does not exist in this
base. Use [getTableByIdIfExists][88] instead if you are unsure whether a table exists with the given
ID.
...
Returns **([Table][87] | null)** The table matching the given ID, or `null` if that table does not
exist in this base.
...
-   `tableName` **[string][66]** The name of the table you're looking for.

Returns **[Table][87]** The table matching the given name. Throws if no table exists with that name
in this base. Use [getTableByNameIfExists][89] instead if you are unsure whether a table exists with
the given name.
...
Returns **([Table][87] | null)** The table matching the given name, or `null` if no table exists
...
Returns **[string][66]** This base's ID.
...
Returns **[string][66]** The name of the base.

#### tables

Type: [Array][67]&lt;[Table][87]>
...
Returns **[Array][67]&lt;[Table][87]>** The tables in this base. Can be watched to know when tables
...
-   `keys` **(WatchableBaseKey | [Array][67]&lt;WatchableBaseKey>)** the keys to unwatch
-   `callback` **[Function][72]** the function passed to `.watch` for these keys
-   `context` **[Object][73]??** the context that was passed to `.watch` for this `callback`

Returns **[Array][67]&lt;WatchableBaseKey>** the array of keys that were unwatched
...
-   `keys` **(WatchableBaseKey | [Array][67]&lt;WatchableBaseKey>)** the keys to watch
-   `callback` **[Function][72]** a function to call when those keys change
-   `context` **[Object][73]??** an optional context for `this` in `callback`.

Returns **[Array][67]&lt;WatchableBaseKey>** the array of keys that were watched
...
-   `keys` **(WatchableSessionKey | [Array][67]&lt;WatchableSessionKey>)** the keys to unwatch
-   `callback` **[Function][72]** the function passed to `.watch` for these keys
-   `context` **[Object][73]??** the context that was passed to `.watch` for this `callback`

Returns **[Array][67]&lt;WatchableSessionKey>** the array of keys that were unwatched
...
-   `keys` **(WatchableSessionKey | [Array][67]&lt;WatchableSessionKey>)** the keys to watch
-   `callback` **[Function][72]** a function to call when those keys change
-   `context` **[Object][73]??** an optional context for `this` in `callback`.

Returns **[Array][67]&lt;WatchableSessionKey>** the array of keys that were watched
...
-   `recordOrRecordId` **([Record][85] \| [string][66])** The record or record ID to check for.
...
Type: [Array][67]&lt;RecordId>

Returns **[Array][67]&lt;RecordId>** The record IDs of all currently selected records, or an empty
...
-   `keys` **(WatchableCursorKey | [Array][67]&lt;WatchableCursorKey>)** the keys to unwatch
-   `callback` **[Function][72]** the function passed to `.watch` for these keys
-   `context` **[Object][73]??** the context that was passed to `.watch` for this `callback`

Returns **[Array][67]&lt;WatchableCursorKey>** the array of keys that were unwatched
...
-   `keys` **(WatchableCursorKey | [Array][67]&lt;WatchableCursorKey>)** the keys to watch
-   `callback` **[Function][72]** a function to call when those keys change
-   `context` **[Object][73]??** an optional context for `this` in `callback`.

Returns **[Array][67]&lt;WatchableCursorKey>** the array of keys that were watched
...
Returns **[Array][67]&lt;[Aggregator][90]>** A list of available aggregators given this field's
configuration.
...
-   `string` **[string][66]** The string to parse.
...
Returns **[string][66]** This field's ID.

#### isAggregatorAvailable

##### Parameters

-   `aggregator` **([Aggregator][90] \| [string][66])** The aggregator object or aggregator key.
...
Returns **[string][66]** The name of the field. Can be watched.
...
Returns **[string][66]** The type of the field. Can be watched.
...
-   `keys` **(WatchableFieldKey | [Array][67]&lt;WatchableFieldKey>)** the keys to unwatch
-   `callback` **[Function][72]** the function passed to `.watch` for these keys
-   `context` **[Object][73]??** the context that was passed to `.watch` for this `callback`

Returns **[Array][67]&lt;WatchableFieldKey>** the array of keys that were unwatched
...
-   `keys` **(WatchableFieldKey | [Array][67]&lt;WatchableFieldKey>)** the keys to watch
-   `callback` **[Function][72]** a function to call when those keys change
-   `context` **[Object][73]??** an optional context for `this` in `callback`.

Returns **[Array][67]&lt;WatchableFieldKey>** the array of keys that were watched
...
-   [TableOrViewQueryResult][91] is the most common, and is a query result filtered to all the
    records in a specific [Table][19] or [View][20]. You can get one of these with
    `table.selectRecords()` or `view.selectRecords()`.
-   [LinkedRecordsQueryResult][92] is a query result of all the records in a particular [linked
    record cell][93]. You can get one of these with `record.selectLinkedRecordsFromCell(someField)`.
...
[useRecords][94], [useRecordIds][95], [useRecordById][96] or [useLoadable][97], which will handle
all that for you.
...
Type: ([Array][67]&lt;[Field][82]> | null)

Returns **([Array][67]&lt;[Field][82]> | null)**
...
Returns **([Record][85] | null)** the record
...
-   `recordOrRecordId` **(RecordId | [Record][85])** the record or record ID you want the color of.

Returns **([Color][98] | null)** a [Color][99], or null if the record has no color in this query
result.
...
-   `recordOrRecordId` **(RecordId | [Record][85])** the record or record id to check the presence
    of
...
Returns **[Promise][71]&lt;void>** A promise that will resolve once the data is loaded.
...
Returns **[Array][67]&lt;RecordId>**

##### records

The records in this RecordQueryResult. Throws if data is not loaded yet. Can be watched.

Type: [Array][67]&lt;[Record][85]>

Returns **[Array][67]&lt;[Record][85]>** all of the records in this query result
...
-   `keys` **(WatchableRecordQueryResultKey | [Array][67]&lt;WatchableRecordQueryResultKey>)** the
    keys to unwatch
-   `callback` **[Function][72]** the function passed to `.watch` for these keys
-   `context` **[Object][73]??** the context that was passed to `.watch` for this `callback`

Returns **[Array][67]&lt;WatchableRecordQueryResultKey>** the array of keys that were unwatched
...
Returns **[Array][67]&lt;WatchableRecordQueryResultKey>** the array of keys that were watched
...
Returns **([Array][67]&lt;[Field][82]> | null)** The fields that were used to create this
LinkedRecordsQueryResult.
...
Returns **[Array][67]&lt;[string][66]>** Ordered array of all the linked record ids.
...
Returns **[Array][67]&lt;[Record][85]>** Ordered array of all the linked records.
...
-   `attachmentId` **[string][66]** The ID of the attachment.
-   `attachmentUrl` **[string][66]** The attachment's URL (which is not suitable for rendering on
    the client).
...
Returns **[string][66]** A URL that is suitable for rendering on the current client.
...
-   `fieldOrFieldIdOrFieldName` **([Field][82] | FieldId | [string][66])** The field (or field ID or
...
Returns **[string][66]** The cell value in the given field, formatted as a `string`.
...
-   `viewOrViewIdOrViewName` **([View][83] \| [string][66])** The view (or view ID or view name) to
    use for record coloring.

Returns **([string][66] | null)** The CSS hex color for this record in the given view, or null if
...
-   `viewOrViewIdOrViewName` **([View][83] | ViewId | [string][66])** The view (or view ID or view
    name) to use for record coloring.

Returns **([Color][98] | null)** The color of this record in the given view, or null if the record
...
Returns **[string][66]** This record's ID.
...
Returns **[string][66]** The primary cell value in this record, formatted as a `string`.
...
-   `fieldOrFieldIdOrFieldName` **([Field][82] | FieldId | [string][66])** The `multipleRecordLinks`
...
-   `keys` **(WatchableRecordKey | [Array][67]&lt;WatchableRecordKey>)** the keys to unwatch
-   `callback` **[Function][72]** the function passed to `.watch` for these keys
-   `context` **[Object][73]??** the context that was passed to `.watch` for this `callback`

Returns **[Array][67]&lt;WatchableRecordKey>** the array of keys that were unwatched
...
Returns **[string][66]** The URL for the record. You can visit this URL in the browser to be taken
...
-   `keys` **(WatchableRecordKey | [Array][67]&lt;WatchableRecordKey>)** the keys to watch
-   `callback` **[Function][72]** a function to call when those keys change
-   `context` **[Object][73]??** an optional context for `this` in `callback`.

Returns **[Array][67]&lt;WatchableRecordKey>** the array of keys that were watched
...
-   `fields` **[object][73]?** object mapping `FieldId` or field name to value for that field.
...
-   `records` **[Array][67]&lt;[object][73]>?** Array of objects mapping `FieldId` or field name to
...
-   `recordsOrRecordIds` **[Array][67]&lt;([Record][85] | RecordId)>?** the records to be deleted
...
-   `fields` **[object][73]?** cell values to update in that record, specified as object mapping
...
Returns **[Promise][71]&lt;[Array][67]&lt;RecordId>>** A promise that will resolve to array of
...
-   `recordsOrRecordIds` **[Array][67]&lt;([Record][85] | RecordId)>** Array of Records and
    RecordIds
...
Returns **[Array][67]&lt;[Field][82]>** The fields in this table. The order is arbitrary, since
...
Returns **([Field][82] | null)** The field matching the given ID, or `null` if that field does not
exist in this table.
...
-   `fieldName` **[string][66]** The name of the field you're looking for.
...
Returns **([Field][82] | null)** The field matching the given name, or `null` if no field exists
...
-   `allowedViewTypes` **([Array][67]&lt;ViewType> | ViewType)** An array of view types or a single
    view type to match against.
-   `preferredViewOrViewId` **([View][83] | ViewId | null)?** If a view or view ID is supplied and
...
Returns **([View][83] | null)** The first view where the type is one of `allowedViewTypes` or `null`
...
Returns **([View][83] | null)** The view matching the given ID, or `null` if that view does not
exist in this table.
...
-   `viewName` **[string][66]** The name of the view you're looking for.
...
Returns **([View][83] | null)** The view matching the given name, or `null` if no view exists with
...
Returns **[boolean][70]** boolean Whether the current user can create the specified record.
...
Returns **[boolean][70]** boolean Whether the current user can create the specified records.
...
Returns **[boolean][70]** boolean Whether the current user can delete the specified record.
...
Returns **[boolean][70]** boolean Whether the current user can delete the specified records.
...
Returns **[boolean][70]** boolean Whether the user can update the specified record.
...
Returns **[boolean][70]** boolean Whether the current user can update the specified records.
...
Returns **[string][66]** This table's ID.
...
Returns **[string][66]** The name of the table. Can be watched.
...
Returns **[Field][82]** The table's primary field. Every table has exactly one primary field. The
...
-   `keys` **(WatchableTableKey | [Array][67]&lt;WatchableTableKey>)** the keys to unwatch
-   `callback` **[Function][72]** the function passed to `.watch` for these keys
-   `context` **[Object][73]??** the context that was passed to `.watch` for this `callback`

Returns **[Array][67]&lt;WatchableTableKey>** the array of keys that were unwatched
...
-   `records` **[Array][67]&lt;{id: RecordId, fields: [object][73]}>** Array of objects containing
...
Returns **[string][66]** The URL for the table. You can visit this URL in the browser to be taken to
the table in the Airtable UI.

#### views

Type: [Array][67]&lt;[View][83]>
...
Returns **[Array][67]&lt;[View][83]>** The views in this table. Can be watched to know when views
...
-   `keys` **(WatchableTableKey | [Array][67]&lt;WatchableTableKey>)** the keys to watch
-   `callback` **[Function][72]** a function to call when those keys change
-   `context` **[Object][73]??** an optional context for `this` in `callback`.

Returns **[Array][67]&lt;WatchableTableKey>** the array of keys that were watched
...
Returns **[string][66]** This view's ID.
...
Returns **[string][66]** The name of the view. Can be watched.
...
Returns **[string][66]** The URL for the view. You can visit this URL in the browser to be taken to
...
-   `keys` **(WatchableKey | [Array][67]&lt;WatchableKey>)** the keys to unwatch
-   `callback` **function (model: this, key: WatchableKey): any** the function passed to `.watch`
    for these keys
-   `context` **[Object][73]??** the context that was passed to `.watch` for this `callback`

Returns **[Array][67]&lt;WatchableKey>** the array of keys that were unwatched
...
-   `keys` **(WatchableKey | [Array][67]&lt;WatchableKey>)** the keys to watch
-   `callback` **function (model: this, key: WatchableKey): any** a function to call when those keys
    change
-   `context` **[Object][73]??** an optional context for `this` in `callback`.

Returns **[Array][67]&lt;WatchableKey>** the array of keys that were watched
...
Given a [Color][99], return the hex color value for that color, or null if the value isn't a
[Color][99]
...
Given a [Color][99], returns true or false to indicate whether that color should have light text on
top of it when used as a background color.

###### Parameters

-   `colorString` **[string][66]** {Color}
...
re-renders quite often, meaning [useRecordIds][95] or [useRecordById][96] could be more appropriate
...
Returns **([Array][67]&lt;[Record][85]> | null)** the records in the query result, or null if no
...
Returns **([Array][67]&lt;RecordId> | null)** the array of record IDs in the query result, or null
...
Often used with [useRecordIds][95] to render a list of records where each list item only updates
...
Returns **([Record][85] | null)** the record, or null if no query result was passed in or no record
...
-   `onClickCallback` **[Function][72]** a callback to call when the button is clicked
...
-   `keys` **[Array][67]&lt;[string][66]?>** which keys we want to watch
...
-   `models` **(QueryResult | [Cursor][132] \| [Array][67]&lt;(QueryResult | [Cursor][132] | null)>
...
-   `record` **[Record][85]** the record to expand
-   `opts` **[object][73]?** An optional options object.
    -   `opts.records` **[Array][67]&lt;[Record][85]>?** If `records` is provided, the list will be
...
Type: {records: [Array][67]&lt;[Record][85]>?}

##### Properties

-   `records` **[Array][67]&lt;[Record][85]>?**
...
-   `records` **[Array][67]&lt;[Record][85]>** the records to expand. Duplicate records will be
    removed.
-   `opts` **{fields: [Array][67]&lt;[Field][82]>?}?** An optional options object.
...
-   `records` **[Array][67]&lt;[Record][85]>** the records the user can pick from. Duplicate records
    will be removed.
-   `opts` **{fields: [Array][67]&lt;[Field][82]>?, shouldAllowCreatingRecord: [boolean][70]?}?** An
...
Returns **[Promise][71]&lt;(record | null)>** a Promise that resolves to the record chosen by the
user or null
...
-   `className` **[string][66]?** Extra `className`s to apply to the button, separated by spaces.
...
-   `type` **[string][66]?** The type of the button.
-   `disabled` **[boolean][70]?** Indicates whether or not the user can interact with the button.
-   `tabIndex` **([number][74] \| [string][66])?** Indicates if the button can be focused and
    if/where it participates in sequential keyboard navigation.
-   `aria-label` **[string][66]?** The label for the button. Use this if the button lacks a visible
    text label.
...
-   `cellValue` **([string][66] \| [number][74] \| [Object][73] \| [Array][67]&lt;[Object][73]>)?**
...
-   `shouldWrap` **[boolean][70]?** Whether to wrap cell contents. Defaults to true.
-   `className` **[string][66]?** Additional class names to apply to the cell renderer container,
    separated by spaces.
-   `style` **[object][73]?** Additional styles to apply to the cell renderer container.
-   `cellClassName` **[string][66]?** Additional class names to apply to the cell itself, separated
    by spaces.
-   `cellStyle` **[object][73]?** Additional styles to apply to the cell itself.
...
-   `choice` **[object][73]** An object representing a select option. You should not create these
    ...
    -   `choice.id` **[string][66]** The ID of the select option.
    -   `choice.name` **[string][66]** The name of the select option.
    -   `choice.color` **[string][66]?** The color of the select option.
-   `style` **[string][66]?** Additional styles to apply to the choice token.
-   `className` **[string][66]?** Additional class names to apply to the choice token.
...
-   `props` **[CollaboratorTokenProps][137]**
...
-   `collaborator` **[object][73]** An object representing a collaborator. You should not create
    ...
    -   `collaborator.id` **[string][66]?** The user ID of the collaborator.
    -   `collaborator.email` **[string][66]?** The email address of the collaborator.
    -   `collaborator.name` **[string][66]?** The name of the collaborator.
    -   `collaborator.status` **[string][66]?** The status of the collaborator.
    -   `collaborator.profilePicUrl` **[string][66]?** The URL of the collaborator's profile
        picture.
-   `className` **[string][66]?** Additional class names to apply to the collaborator token.
-   `style` **[string][66]?** Additional styles to apply to the collaborator token.
...
-   `color` **[string][66]?** The current selected [Color][99] option.
-   `allowedColors` **[Array][67]&lt;[string][66]>** The list of [colors][119] to display in the
    color palette.
-   `onChange` **[function][72]?** A function to be called when the selected color changes.
-   `squareMargin` **[number][74]?** The margin between color squares in the color palette.
-   `className` **[string][66]?** Additional class names to apply to the color palette, separated by
    spaces.
-   `style` **[object][73]?** Additional styles to apply to the color palette.
-   `disabled` **[boolean][70]?** If set to `true`, the color palette will not allow color
    selection.
...
-   `title` **[string][66]** The title of the dialog.
-   `body` **React.Node?** The body of the dialog.
-   `cancelButtonText` **[string][66]?** The label for the cancel button.
-   `confirmButtonText` **[string][66]?** The label for the confirm button.
-   `isConfirmActionDangerous` **[boolean][70]?** Whether the action is dangerous (potentially
    destructive or not easily reversible).
-   `className` **[string][66]?** Extra `className`s to apply to the dialog element, separated by
    spaces.
-   `style` **[Object][73]?** Extra styles to apply to the dialog element.
-   `backgroundClassName` **[string][66]?** Extra `className`s to apply to the background element,
    separated by spaces.
-   `backgroundStyle` **[Object][73]?** Extra styles to apply to the background element.
-   `onCancel` **[function][72]** Cancel button event handler. Handles click events and Space/Enter
    keypress events.
-   `onConfirm` **[function][72]** Confirm button event handler. Handles click events and
...
-   `className` **[string][66]?** `className`s to apply to the close button, separated by spaces.
...
-   `field` **[Field][82]?** The selected field model.
-   `table` **[Table][87]?** The parent table model to select fields from. If `null` or `undefined`,
    the picker won't render.
-   `allowedTypes` **[Array][67]&lt;FieldType>?** An array indicating which field types can be
    selected.
-   `shouldAllowPickingNone` **[boolean][70]?** If set to `true`, the user can unset the selected
    field.
-   `placeholder` **[string][66]?** The placeholder text when no field is selected.
-   `onChange` **[function][72]?** A function to be called when the selected field changes.
-   `autoFocus` **[string][66]?** The `autoFocus` attribute.
-   `disabled` **[boolean][70]?** If set to `true`, the user cannot interact with the select.
-   `id` **[string][66]?** The `id` attribute.
-   `name` **[string][66]?** The `name` attribute.
-   `tabIndex` **([number][74] \| [string][66])?** The `tabindex` attribute.
-   `className` **[string][66]?** Additional class names to apply to the select.
-   `style` **[object][73]?** Additional styles to apply to the select.
-   `aria-label` **[string][66]?** The `aria-label` attribute. Use this if the select is not
    referenced by a label element.
-   `aria-labelledby` **[string][66]?** A space separated list of label element IDs.
-   `aria-describedby` **[string][66]?** A space separated list of description element IDs.
...
-   `name` **[string][66]** The name of the icon. For more details, see the [list of supported
    icons][146].
-   `size` **[number][74]?** The width/height of the icon.
-   `fillColor` **[string][66]?** The color of the icon.
-   `className` **[string][66]?** Additional class names to apply to the icon.
-   `style` **[object][73]?** Additional styles to apply to the icon.
-   `pathClassName` **[string][66]?** Additional class names to apply to the icon path.
...
-   `field` **[Field][82]** The field model to display an icon for.
-   `size` **[number][74]?** The width/height of the icon.
-   `fillColor` **[string][66]?** The color of the icon.
-   `className` **[string][66]?** Additional class names to apply to the icon.
-   `style` **[object][73]?** Additional styles to apply to the icon.
...
-   `value` **[string][66]** The input's current value.
-   `onChange` **[function][72]** A function to be called when the input changes.
-   `type` **[string][66]?** The `type` for the input. Defaults to `text`.
-   `placeholder` **[string][66]?** The placeholder for the input.
-   `style` **[object][73]?** Additional styles to apply to the input.
-   `className` **[string][66]?** Additional class names to apply to the input, separated by spaces.
-   `disabled` **[boolean][70]?** The `disabled` attribute.
-   `required` **[boolean][70]?** The `required` attribute.
-   `spellCheck` **[boolean][70]?** The `spellcheck` attribute.
-   `name` **[string][66]?** The `name` attribute.
-   `id` **[string][66]?** The `id` attribute.
-   `autoFocus` **[boolean][70]?** The `autoFocus` attribute.
-   `max` **([number][74] \| [string][66])?** The `max` attribute.
-   `maxLength` **[number][74]?** The `maxLength` attribute.
-   `min` **([number][74] \| [string][66])?** The `min` attribute.
-   `minLength` **[number][74]?** The `minLength` attribute.
-   `step` **([number][74] \| [string][66])?** The `step` attribute.
-   `pattern` **[string][66]?** The `pattern` attribute.
-   `readOnly` **[boolean][70]?** The `readOnly` attribute.
-   `autoComplete` **[string][66]?** The `autoComplete` attribute.
-   `tabIndex` **([number][74] \| [string][66])?** The `tabindex` attribute.
-   `aria-labelledby` **[string][66]?** A space separated list of label element IDs.
-   `aria-describedby` **[string][66]?** A space separated list of description element IDs.
...
-   `globalConfigKey` **([string][66] \| [Array][67]&lt;[string][66]>)** The key, or path to a key,
    in global config.
-   `onChange` **[function][72]** A function to be called when the input changes.
-   `type` **[string][66]?** The `type` for the input. Defaults to `text`.
-   `placeholder` **[string][66]?** The placeholder for the input.
...
-   `size` **(`"xsmall"` \| `"small"` \| `"default"` \| `"large"`)?** The `size` of the label.
    Defaults to `default`. Can be a responsive prop object.
-   `htmlFor` **[string][66]?** The `for` attribute. Should contain the `id` of the input.
-   `role` **[string][66]?** The `role` attribute.
-   `className` **[string][66]?** Additional class names to apply, separated by spaces.
-   `style` **[object][73]?** Additional styles.
-   `dataAttributes` **[object][73]?** Data attributes that are spread onto the element
    `dataAttributes={{'data-*': '...'}}`.
-   `aria-label` **[string][66]?** The `aria-label` attribute.
-   `aria-labelledby` **[string][66]?** The `aria-labelledby` attribute. A space separated list of
    label element IDs.
-   `aria-describedby` **[string][66]?** The `aria-describedby` attribute. A space separated list of
    description element IDs.
-   `aria-controls` **[string][66]?** The `aria-controls` attribute.
-   `aria-expanded` **[string][66]?** The `aria-expanded` attribute.
-   `aria-haspopup` **[string][66]?** The `aria-haspopup` attribute.
-   `aria-hidden` **[string][66]?** The `aria-hidden` attribute.
-   `aria-live` **[string][66]?** The `aria-live` attribute.
...
-   Limited XSS protection. If the `href` starts with `javascript:` or `data:`, `http://` will be
    prepended.
-   There is [reverse tabnabbing prevention][151]. If `target` is set, the `rel` attribute will be
...
-   `href` **[string][66]** The target URL or URL fragment for the link.
-   `target` **[string][66]?** Specifies where to display the linked URL.
-   `tabIndex` **([number][74] \| [string][66])?** Indicates if the link can be focused and if/where
    it participates in sequential keyboard navigation.
-   `className` **[string][66]?** Additional class names to apply to the link.
...
-   `fillColor` **[string][66]?** The color of the loading spinner.
-   `scale` **[number][74]?** A scalar for the loading spinner. Increasing the scale increases the
    size of the loading spinner.
-   `className` **[string][66]?** Additional class names to apply to the loading spinner.
-   `style` **[object][73]?** Additional styles to apply to the loading spinner.
...
-   `backgroundClassName` **[string][66]?** Extra class names for the background of the popover,
    separated by spaces.
...
-   `progress` **[number][74]** A number between 0 and 1. 0 is 0% complete, 0.5 is 50% complete, 1
    ...
    inside of the range.
-   `barColor` **[string][66]?** A CSS color, such as `#ff9900`.
-   `backgroundColor` **[string][66]?** A CSS color, such as `#ff9900`.
-   `height` **[number][74]?** A height, in pixels.
-   `className` **[string][66]?** Extra `className`s to apply to the element, separated by spaces.
...
-   `record` **[Record][85]** Record to display in the card.
-   `fields` **[Array][67]&lt;[Field][82]>?** Fields to display in the card. The primary field is
    always displayed.
-   `view` **[View][83]?** The view model to use for field order and record coloring.
-   `attachmentCoverField` **[Field][82]?** Attachment field to display as an image in the square
...
-   `expandRecordOptions` **[object][73]?** Options object for expanding a record.
    -   `expandRecordOptions.records` **[Array][67]&lt;[Record][85]>?** List of all records, used
...
-   `className` **[string][66]?** Additional class names to apply to the record card.
...
-   `records` **[Array][67]&lt;[Record][85]>** Records to display in card list.
...
-   `onRecordMouseLeave` **[function][72]?** Mouse leave event handler for an individual record
    card.
-   `fields` **[Array][67]&lt;[Field][82]>?** Fields to display in each record card. The primary
...
-   `attachmentCoverField` **[Field][82]?** Attachment field to display as an image in the square
    ...
    the view.
-   `className` **[string][66]?** Additional class names to apply to the record card list.
...
-   `value` **([string][66] \| [number][74] \| [boolean][70] | null)?** The value of the selected
    option.
-   `options` **[Array][67]&lt;[SelectOption][159]>** The list of select options.
...
-   `value` **([string][66] \| [number][74] \| [boolean][70] | null)** The value for the select
    option.
...
-   `table` **[Table][87]?** The selected table model.
-   `shouldAllowPickingNone` **[boolean][70]?** If set to `true`, the user can unset the selected
    table.
-   `placeholder` **[string][66]?** The placeholder text when no table is selected.
...
-   `name` **[string][66]?** The `name` attribute.
-   `tabIndex` **([number][74] \| [string][66])?** The `tabindex` attribute.
-   `className` **[string][66]?** Additional class names to apply to the picker.
...
-   `props` **[TablePickerSyncedProps][162]**
...
-   `className` **[string][66]?** Additional class names to apply to the switch.
-   `style` **[object][73]?** Additional styles to apply to the switch.
-   `aria-label` **[string][66]?** The label for the switch. Use this if the switch lacks a visible
    text label.
-   `aria-labelledby` **[string][66]?** A space separated list of label element IDs.
-   `aria-describedby` **[string][66]?** A space separated list of description element IDs.
...
-   `children` **React\$Element&lt;any>** Child components to render.
-   `content` **([string][66] \| [function][72])** A string representing the contents.
...
-   `className` **[string][66]?** Additional class names to attach to the tooltip, separated by
    spaces.
...
-   `view` **[View][83]?** The selected view model.
-   `table` **[Table][87]?** The parent table model to select views from. If `null` or `undefined`,
    the picker won't render.
-   `allowedTypes` **[Array][67]&lt;ViewType>?** An array indicating which view types can be
    selected.
-   `shouldAllowPickingNone` **[boolean][70]?** If set to `true`, the user can unset the selected
    view.
-   `placeholder` **[string][66]?** The placeholder text when no view is selected.
...
-   `props` **[ViewPickerSyncedProps][167]**
...
ViewportConstraint - when mounted, applies constraints to the viewport. Like [addMinSize][168], will
...
Type: {minSize: [ViewportSizeConstraintProp][169]?, maxFullscreenSize:
[ViewportSizeConstraintProp][169]?, children: React.Node?}

##### Properties

-   `minSize` **[ViewportSizeConstraintProp][169]?**
-   `maxFullscreenSize` **[ViewportSizeConstraintProp][169]?**
-   `children` **React.Node?**
...
[75]: #usesettingsbutton
[76]: #addmaxfullscreensize
[77]: #minsize
[78]: https://www.iso.org/iso-8601-date-and-time-format.html
[79]: #fieldtypesdate
[80]: #fieldtypesdate_time
[81]: https://airtable.com/universe
[82]: #field
[83]: #view
[84]: #recordcoloringmodes
[85]: #record
[86]: #getcollaboratorbyidifexists
[87]: #table
[88]: #gettablebyidifexists
[89]: #gettablebynameifexists
[90]: #aggregator
[91]: #tableorviewqueryresult
[92]: #linkedrecordsqueryresult
[93]: https://support.airtable.com/hc/en-us/articles/206452848-Linked-record-fields
[94]: #userecords
[95]: #userecordids
[96]: #userecordbyid
[97]: #useloadable
...
[147]: #fieldiconprops
[148]: #inputprops
[149]: #inputsyncedprops
[150]: #labelprops
[151]: https://www.owasp.org/index.php/Reverse_Tabnabbing
[152]: #linkprops
[153]: #loaderprops
[154]: #popoverprops
[155]: #progressbarprops
[156]: #recordcardprops
[157]: #recordcardlistprops
[158]: #selectprops
[159]: #selectoption
[160]: #selectsyncedprops
[161]: #tablepickerprops
[162]: #tablepickersyncedprops
[163]: #toggleprops
[164]: #togglesyncedprops
[165]: #tooltipprops
[166]: #viewpickerprops
[167]: #viewpickersyncedprops
[168]: #addminsize
[169]: #viewportsizeconstraintprop
