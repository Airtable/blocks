...
describe('Cursor', () => {
    ...
    beforeEach(() => {
        ...
        // Some tests are designed to trigger the `isDataLoaded` event.
        // However, the SDK automatically triggers this event upon
        // initialization. In order to ensure that the tests for the event are
