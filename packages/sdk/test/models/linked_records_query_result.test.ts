...
describe('LinkedRecordQueryResult', () => {
    ...
    beforeEach(async () => {
        ...
        // The SDK automatically triggers the `isDataLoaded` event upon
    ...
    describe('#isValid', () => {
        ...
        it('false following change in field type (unloaded)', async () => {
            ...
            // that the model responds to the subsequent update but remains
            // unloaded.
    ...
    describe('#fields', () => {
        ...
        it('returns an array of the fields initially specified', async () => {
            ...
            // Assert type syntactically so the type system is aware.
            //
    ...
    describe('#watch', () => {
        ...
        describe('key: cellValues', () => {
            it('triggers loading', async () => {
                ...
                // Although watching the `cellValues` key does in fact trigger
                // loading, this is not immediately observable because the
                // event handler is invoked once the foreign record is loaded.
                // The linked record's "loaded" state changes in a subsequent
                // phase.
        ...
        describe('key: recordColors', () => {
            it('triggers loading', async () => {
                ...
                // This promise is not expected to settle without additional
                // automation. That isn't relevant for the current test, so the
