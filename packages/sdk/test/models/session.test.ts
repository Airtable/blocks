...
// Rely on the Sdk model to create the Session instance under test. Although
// this creates some undesirable coupling between the tests, it also reduces
// the amount of inauthentic test logic that would be necessary to verify
// functionality (e.g. model event handling).
