...
// also i think it needs to be a separate file?
...
`);
        ...
        describe('CREATE_MULTIPLE_RECORDS', () => {
            const validRecord = {
                ...
                cellValuesByFieldId: {
                    fldPrjctName: 9,
                    // The following field is intentionally left unloaded in
                    // order to verify that such fields are omitted from
        ...
        it('rejects unrecognized mutation types', async () => {
            ...
            await expect(
                mutations.applyMutationAsync({
                    ...
                    tableId: 'tblNonExistentTableId',
                    // Include a circular reference to verify that the error
                    // reported describes the type problem and not the more
                    // generic "circular reference" problem.
