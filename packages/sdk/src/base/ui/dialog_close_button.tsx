...
export function DialogCloseButton(props: DialogCloseButtonProps) {
    ...
    const {onMouseEnter, onMouseLeave, className, style, tabIndex, onClick, children} = props;
...
export default withStyledSystem<
    ...
    React.ComponentType<DialogCloseButtonProps>,
    {}
>(DialogCloseButton, styleParser, {
    position: 'absolute',
    top: 0,
    right: 0,
    marginTop: 2,
