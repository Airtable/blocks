...
2. Create a new block in your new base (see the [setup guide](/packages/sdk/docs/setup.md)), pasting
   the template block token `@airtable/simple-chart-block` into the `template` field.
...
```
@airtable/simple-chart-block
```

## See the block running

![Block updating chart as the user changes data](https://raw.githubusercontent.com/Airtable/blocks/master/examples/simple-chart-block/media/block.gif?token=AAAAVHHMFXI2GLSMHKVAIRS5M3FUQ)
