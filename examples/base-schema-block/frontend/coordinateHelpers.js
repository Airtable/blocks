 ...
 *
 * It's likely that a table will be created while this extension is not running, in which case our
 * globalConfig-persisted table coordinates will become stale. The next time we run the extension,
