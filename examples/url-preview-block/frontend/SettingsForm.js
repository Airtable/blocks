    ...
    return (
        ...
        >
            <Box flex="auto" padding={4} paddingBottom={2}>
                ...
                <FormField label="">
                    <Switch
                        aria-label="When enabled, the extension will only show previews for the specified table and field, regardless of what field is selected."
                        value={isEnforced}
                        onChange={value => {
                    ...
                    <Text paddingY={1} textColor="light">
                        {isEnforced
                            ? 'The extension will show previews for the selected record in grid view if the table has a supported URL in the specified field.'
                            : 'The extension will show previews if the selected cell in grid view has a supported URL.'}
                    </Text>
                </FormField>
                {isEnforced && (
