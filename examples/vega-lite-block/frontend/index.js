...
function VegaLiteExtension() {
    ...
    useSettingsButton(() => {
        ...
        // This extension has a substantial settings form. If the user triggers
        // settings for opening, then the extension must insist on opening in
...
initializeBlock(() => <VegaLiteExtension />);
