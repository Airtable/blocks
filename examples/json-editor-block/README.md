...
allowing them to modify the cell value and alerts them of syntax errors. It allows users to alter
the behavior of the editor through a form on a dedicated settings page.
