  ...
  (0, _createClass2.default)(AbstractModelWithAsyncData, [{
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                if (!this._pendingDataLoadPromise) {
                  ...
                  this._pendingDataLoadPromise.then(function (changedKeys) {
                    _this2._isDataLoaded = true;
                    _this2._pendingDataLoadPromise = null;
                    var _iteratorNormalCompletion3 = true;
                    var _didIteratorError3 = false;
                    var _iteratorError3 = undefined;

                    try {
                      for (var _iterator3 = (0, _getIterator2.default)(changedKeys), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        var key = _step3.value;

                        _this2._onChange(key);
                      }
                    } catch (err) {
    ...
    value: function unloadData() {
      ...
      if (this._dataRetainCount === 0) {
        ...
        // the network.
        this._unloadDataTimeoutId = (0, _setTimeout2.default)(function () {
          h.assert(_this3._dataRetainCount === 0, 'Unload data timeout fired with non-zero retain count'); // Set _isDataLoaded to false before calling _unloadData in case
          // _unloadData reads from isDataLoaded.

          _this3._isDataLoaded = false;
