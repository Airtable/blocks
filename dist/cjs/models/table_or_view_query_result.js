...
class TableOrViewQueryResult extends _query_result.default {
  ...
  constructor(sourceModel, opts) {
    ...
    this._table = table;
    var sorts = this._normalizedOpts.sorts;
    ...
    if (this._normalizedOpts.fieldIdsOrNullIfAllFields) {
      ...
      try {
        for (var _iterator = this._normalizedOpts.fieldIdsOrNullIfAllFields[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (this._groupLevels) {
        ...
        try {
          for (var _iterator2 = this._groupLevels[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  get fields() {
    ...
    if (fieldIdsOrNullIfAllFields) {
      ...
      try {
        for (var _iterator4 = fieldIdsOrNullIfAllFields[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              if (_this._fieldIdsSetToLoadOrNullIfAllFields) {
                cellValuesInFieldsLoadPromise = _this._table.loadCellValuesInFieldIdsAsync(Object.keys(_this._fieldIdsSetToLoadOrNullIfAllFields));
              } else {
                // Load all fields.
                cellValuesInFieldsLoadPromise = _this._table.loadDataAsync();
              }

              if (_this._sourceModel instanceof _table.default) {
                if (_this._fieldIdsSetToLoadOrNullIfAllFields) {
                  sourceModelLoadPromise = _this._table.loadRecordMetadataAsync();
                } else {
                ...
                sourceModelLoadPromise = _this._sourceModel.loadDataAsync();
              }

              _this._mostRecentSourceModelLoadPromise = Promise.all([sourceModelLoadPromise, cellValuesInFieldsLoadPromise, _this._loadRecordColorsAsync()]);
              _context.next = 5;
  ...
  _loadDataAsync() {
    ...
    _regenerator.default.mark(function _callee2() {
      var _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, groupLevel, field, changedKeys, fieldIds, _iteratorNormalCompletion8, _didIteratorError8, _iteratorError8, _iterator8, _step8, fieldId;

      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              tableOrViewQueryResultPool.registerObjectForReuse(_this2);
              (0, _invariant.default)(_this2._mostRecentSourceModelLoadPromise, 'No source model load promises');
              _context2.next = 4;
              return _this2._mostRecentSourceModelLoadPromise;

            case 4:
              if (_this2._groupLevels) {
                _this2._replaceVisList();
              }

              _this2._orderedRecordIds = _this2._generateOrderedRecordIds();

              _this2._sourceModel.watch( // flow-disable-next-line since we know this watch key is valid.
              _this2._recordsWatchKey, _this2._onRecordsChanged, _this2);

              _this2._table.watch(_this2._cellValuesForSortWatchKeys, _this2._onCellValuesForSortChanged, _this2);

              _this2._table.watch(_this2._fieldsWatchKey, _this2._onTableFieldsChanged, _this2);
              ...
              _context2.prev = 13;
              _iterator7 = _this2._groupLevels[Symbol.iterator]();
            ...
            case 19:
              field = _this2._table.getFieldById(groupLevel.columnId);

              if (field) {
                field.watch('type', _this2._onFieldConfigChanged, _this2);
                field.watch('options', _this2._onFieldConfigChanged, _this2);
              }
            ...
            case 38:
              ...
              fieldIds = _this2._normalizedOpts.fieldIdsOrNullIfAllFields || _this2._table.fields.map(field => field.id);
              _iteratorNormalCompletion8 = true;
              _didIteratorError8 = false;
              _iteratorError8 = undefined;
              _context2.prev = 43;

              for (_iterator8 = fieldIds[Symbol.iterator](); !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                fieldId = _step8.value;
      ...
      }, _callee2, null, [[13, 26, 30, 38], [31,, 33, 37], [43, 47, 51, 59], [52,, 54, 58]]);
    }))();
  }
  ...
  _unloadData() {
    ...
    if (!this._table.isDeleted && this._groupLevels) {
      ...
      try {
        for (var _iterator9 = this._groupLevels[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
          var groupLevel = _step9.value;
  ...
  _addRecordIdsToVisList(recordIds) {
    ...
    try {
      for (var _iterator10 = recordIds[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
  ...
  _onRecordsChanged(model, key, updates) {
    ...
    if (this._recordIdsSet) {
      ...
      try {
        for (var _iterator11 = addedRecordIds[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
      ...
      try {
        for (var _iterator12 = removedRecordIds[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
  ...
  _onTableFieldsChanged(table, key, updates) {
    ...
    try {
      for (var _iterator13 = addedFieldIds[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
  ...
  _replaceVisList() {
    ...
    try {
      for (var _iterator14 = this._sourceModelRecords[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
