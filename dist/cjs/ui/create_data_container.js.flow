...
function getReactComponent<Props: {}>(
...
export type WatchDependency = {
    watch: ?Watchable<any>, // eslint-disable-line flowtype/no-weak-types
...
function createDataContainer<Props: {}, ComponentType: React.ComponentType<Props>>(
    Component: ComponentType,
    getDependencies: (props: Props) => Array<?WatchDependency>,
    passthruMethodNames: ?Array<string>,
): ComponentType {
    const ComponentClass = getReactComponent(Component);
    ...
    class DataContainer extends React.Component<Props> {
        ...
        _wrappedComponent: React.Component<Props> | null = null;
        _wrappedWatchConfigs: Array<WrappedWatchConfig> | null = null;
        _shouldUpdateDependenciesOnComponentDidUpdate: boolean = false;
