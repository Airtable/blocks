...
function (_React$Component) {
  ...
  function BlockWrapper(props) {
    ...
    (0, _get_sdk.default)().UI.globalAlert.watch('__alertInfo', function () {
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, this.props.children, viewport.isSmallerThanMinSize && React.createElement("div", {
        ...
        onClick: function onClick() {
          return viewport.enterFullscreen();
        }
      }, "fullscreen"))));
    }
  }]);
...
var _default = (0, _create_data_container.default)(BlockWrapper, function () {
  return [{
