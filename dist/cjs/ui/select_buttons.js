...
function (_React$Component) {
  ...
  (0, _createClass2.default)(SelectButtons, [{
    ...
    value: function render() {
      ...
      var restOfProps = u.omit(this.props, (0, _keys.default)(SelectButtons.propTypes));
      return React.createElement("div", (0, _extends2.default)({
        ...
        return React.createElement("div", {
          ...
          onClick: !isOptionDisabled && function () {
            return _this._onChange(option.value);
          },
          onKeyDown: !isOptionDisabled && function (e) {
            return _this._onKeyDown(e, option.value);
          },
