...
function (_React$Component) {
  ...
  function Popover(props) {
    ...
    _this._refreshContainerAsync = (0, _bind.default)(_context3 = _this._refreshContainerAsync).call(_context3, (0, _assertThisInitialized2.default)(_this));
    return _this;
  }
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                content = React.cloneElement(content, {
                  ref: function ref(el) {
                    return _this2._popoverContent = el;
                  },
