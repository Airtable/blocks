...
var INVALID_BLOCK_JSON_ERROR_MESSAGE = "block.json must be an object with the following properties:\n\n- frontendEntry: string";



var OLD_BLOCK_JSON_FORMAT_ERROR_MESSAGE = 'It looks like you are working on a block that is not yet migrated to the new block.json format. You may need to use an old version of blocks-cli';

function doesBlockJsonResembleOldFormat(blockJson) {
...
function validateBlockJson(blockJson) {
